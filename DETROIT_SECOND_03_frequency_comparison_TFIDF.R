...
#save to file
write_csv(top_tfidf_per_speaker, "output/detroit_night2_tfidf_singleword_percandidate.csv")
...
ggsave("img/detroit2_speaker_tfidf_chart.jpg", speaker_tfidf_chart)
ggsave("img/detroit2_speaker_tfidf_chart.pdf", speaker_tfidf_chart)
...
#save to file
write_csv(top_tfidf_per_speaker_bigrams, "output/detroit_night2_tfidf_bigrams_percandidate.csv")
...
ggsave("img/detroit2_speaker_tfidf_chart_bigrams.jpg", speaker_tfidf_chart_bigrams)
ggsave("img/detroit2_speaker_tfidf_chart_bigrams.pdf", speaker_tfidf_chart_bigrams)
